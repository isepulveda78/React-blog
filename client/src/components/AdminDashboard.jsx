        ...
        <div className="col-md-6 col-lg-4">
          <div className="card h-100 shadow-sm hover-shadow">
            <div className="card-body text-center">
              ...
              <p className="card-text">Test sound effects and audio integration examples.</p>
              <button
                className="btn btn-primary"
        ...
        <div className="col-md-6 col-lg-4">
          <div className="card h-100 shadow-sm hover-shadow">
            <div className="card-body text-center">
              ...
              <p className="card-text">Audio implementation documentation and best practices.</p>
              <button
                className="btn btn-primary"
